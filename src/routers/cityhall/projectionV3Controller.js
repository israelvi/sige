...
var projectionV3Controller = {};

projectionV3Controller.init = function (app, router) {
    
    router.get('/projectionV3', function (req, res) {
        ...
        var partidos = [{ color: "#FF0000", name: 'PRI' }, { color: "#0000FF", name: 'PAN' }, { color: "#FFFF00", name: 'PRD' }];
        ...
        connection.query(cthallQry.qryCandidatos, function (err, rows) {
            ...
            async.map(lstQuerys, queryElec, function (asyErr, results) {
                ...
                res.render('cityhall/projectionV3', {
    ...
    router.post('/projectionSaveV3', function (req, res) {
        var connection = mysql.createConnection(connectionInfo);
        ...
        var arrParams = [idMun, keyParam, 3, param, param];
...
module.exports = projectionV3Controller;

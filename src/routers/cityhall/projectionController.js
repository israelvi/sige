...
projectionController.init = function (app, router) {
    ...
    router.get('/projection', function (req, res) {
        ...
        connection.query(cthallQry.qryCandidatos, function (err, rows) {
            ...
            async.map(lstQuerys, queryElec, function (asyErr, results) {
                ...
                res.render('cityhall/projection', {
    ...
    router.post('/projectionSave', function (req, res) {
        var connection = mysql.createConnection(connectionInfo);
        ...
        var arrParams = [idMun, keyParam, 1, param, param];

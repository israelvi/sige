...
var projectionV2Controller = {};

projectionV2Controller.init = function (app, router) {
    
    router.get('/projectionV2', function (req, res) {
        ...
        connection.query(cthallQry.qryCandidatos, function (err, rows) {
            ...
            async.map(lstQuerys, queryElec, function (asyErr, results) {
                ...
                res.render('cityhall/projectionV2', {
    ...
    router.post('/projectionV2Save', function (req, res) {
        var connection = mysql.createConnection(connectionInfo);
        ...
        var arrParams = [idMun, keyParam, 2, param, param];
...
module.exports = projectionV2Controller;
